...
PCA is an algebraic operation which decomposes $X^TX$ matrix (which is related to the *autocorrelation matrix*, $E[XX^T]$ of the data). It is an eigen-decomposition which helps us extract: 
